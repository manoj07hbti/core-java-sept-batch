...
public class My_Country1 {
    ...
    public My_Country1(String countryName, String cityName, String district, int flatNumber, int pinCode) {
 ...
 My_Country1 country = new My_Country1("India","Firozabad","Firozabad",213,283145);
